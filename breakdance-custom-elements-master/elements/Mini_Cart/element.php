...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\MiniCart",
...
class MiniCart extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "borders",
       ['type' => 'popout']
        ...
        "Size",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 64, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Space After",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 40, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        false,
        false,
        [],
        ...
        "Space Before",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'condition' => ['path' => 'design.link.quantity.overlap', 'operand' => 'is not set', 'value' => ''], 'rangeOptions' => ['min' => 0, 'max' => 40, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        false,
        false,
        [],
        ...
        "Right Nudge",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 0, 'max' => 40, 'step' => 1]],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Style",
        [],
        ['type' => 'button_bar', 'layout' => 'inline', 'items' => [['value' => 'dropdown', 'text' => 'Dropdown'], ['text' => 'Sidebar', 'value' => 'sidebar']], 'buttonBarOptions' => ['size' => 'small', 'layout' => 'default']],
        false,
        false,
        [],
        ...
        "Dropdown Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'left', 'text' => 'Left'], ['text' => 'Center', 'value' => 'center'], ['text' => 'Right', 'value' => 'right']], 'condition' => ['path' => 'design.cart.style', 'operand' => 'not equals', 'value' => 'sidebar']],
        false,
        false,
        [],
        ...
        "Sidebar Position",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'left', 'text' => 'Left'], ['text' => 'Right', 'value' => 'right']], 'condition' => ['path' => 'design.cart.style', 'operand' => 'equals', 'value' => 'sidebar']],
        false,
        false,
        [],
        ...
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'left', 'text' => 'Left'], ['text' => 'Right', 'value' => 'right']], 'condition' => ['path' => 'design.cart.full_screen_at', 'operand' => 'is set', 'value' => 'sidebar']],
        false,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Size",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 12, 'max' => 40, 'step' => 1]],
        true,
        false,
        [],
        ...
        "Separator Height",
        [],
        ['type' => 'unit', 'layout' => 'vertical', 'rangeOptions' => ['min' => 0, 'max' => 4, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        true,
        false,
        [],
      ...
      "borders",
       ['type' => 'popout']
        ...
        "Size",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 4, 'max' => 40, 'step' => 1], 'unitOptions' => ['types' => ['px'], 'defaultType' => 'px']],
        true,
        false,
        [],
      ...
      "typography",
       ['type' => 'popout']
        ...
        "Max Width",
        [],
        ['type' => 'text', 'layout' => 'vertical', 'placeholder' => '450px'],
        false,
        false,
        [],
        ...
        "Initial Height",
        [],
        ['type' => 'text', 'layout' => 'vertical', 'placeholder' => '60px'],
        false,
        false,
        [],
    ...
    static function contentControls()
    {
        ...
        [],
        ['type' => 'toggle', 'layout' => 'inline', 'condition' => [[['path' => 'content.content.link.hide_count', 'operand' => 'is not set', 'value' => '']]]],
        false,
        false,
        [],
        ...
        [],
        ['type' => 'toggle', 'layout' => 'inline', 'condition' => [[['path' => 'content.content.link.hide_subtotal', 'operand' => 'is not set', 'value' => '']]]],
        false,
        false,
        [],
        ...
        "Top Bar",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'enable', 'text' => 'Enable'], ['text' => 'Disable', 'value' => 'disable']]],
        false,
        false,
        [],
        ...
        "Primary Button",
        [],
        ['type' => 'button_bar', 'layout' => 'vertical', 'items' => [['value' => 'cart', 'text' => 'Cart'], ['text' => 'Checkout', 'value' => 'checkout']]],
        false,
        false,
        [],
        ...
        [],
        ['type' => 'dropdown', 'layout' => 'vertical', 'items' => [['text' => 'Disabled', 'value' => 'disabled'], ['value' => 'homepage', 'text' => 'Homepage'], ['text' => 'Shop Page', 'value' => 'shop'], ['text' => 'Custom', 'value' => 'custom']]],
        false,
        false,
        [],
    ...
    {
        return [
            '0' => ['scripts' => ['%%BREAKDANCE_REUSABLE_GSAP%%']],
            '1' => ['scripts' => [plugin_dir_url(__FILE__) . 'frontend.js']]
        ];
    }
